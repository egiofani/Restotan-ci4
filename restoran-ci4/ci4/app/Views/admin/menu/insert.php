...
<div class="container-fluid">
  ...
  <div class="m-5">
        <h1 class="mb-3">Form Insert Menu</h1>
                  ...
                  <div class="container-fluid">
                      ...
                      ?>
                            <div class="form-group">
                                <label > Menu</label>
                                  <input type="text" class="form-control required digits"   name="menu" >
                            </div>
                            <div class="form-group">
                                <label > Harga</label>
                                  <input type="text" class="form-control required digits"   name="harga" >
                            </div>
                            <div class="form-group">
