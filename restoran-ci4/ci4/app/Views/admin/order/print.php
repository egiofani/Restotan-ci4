...
<?= $this->extend('templateadmin/homepage') ?>
...
<div class="container-fluid">
  ...
  <h1 class="mb-2">Struk Pembayaran</h1>
     ...
     <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <h3>
                    <i class="fas fa-globe"></i> <?= $identitas[0]['apotek'] ?>
                  </h>
                </div>
              ...
              <div class="row invoice-info">
                <div class="col-sm-4 invoice-col">
                  ...
                  <address>
                    ...
                    <strong>Alamat:</strong> <?= $identitas[0]['alamat'] ?><br>
                    <strong>Telp  :</strong> <?= $identitas[0]['telp'] ?><br>
                    <strong>Email :</strong> <?= $identitas[0]['email'] ?><br>
                  </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                  To
                  <address>
                    <strong><?= strtoupper($order[0]['nama'] )?></strong><br>
                ...
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    <?php foreach($detail as $key => $value): ?>
                      <tr>
                        <th><?= $no++ ?></th>
                        <td><img src="<?= base_url("/upload/".$value['gambar']);?>" class="float-left" style=" max-height: 40px;max-width: 100%; object-fit: contain; margin:3px; margin-right:6px; margin-top:-5px;"><p><?= $value['barang'] ?></p></td>
              ...
              <div class="row no-print">
                <div class="col-12">
                 <!-- /.invoice <a href="invoice-print.html" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a> 
                  <a href="<?= base_url() ?>/admin/order/print">
                  <button type="button" class="btn btn-blok  btn-outline-primary  col-3  mr-2" data-toggle="modal" ><i class="fas fa-print"></i>
                      Print
                  </button>
                  </a>
                  <a href="<?= base_url() ?>/admin/order">
                  <button type="button" class="btn btn-blok  btn-outline-danger  col-3  " data-toggle="modal"><i class="fas fa-back"></i>
                      kembali
                  </button>
                  </a>-->
